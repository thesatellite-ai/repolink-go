...
// The RepoMappingFunc type is an adapter to allow the use of ordinary
// function as RepoMapping mutator.
type RepoMappingFunc func(context.Context, *ent.RepoMappingMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RepoMappingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RepoMappingMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RepoMappingMutation", m)
}
...
// The RunLogFunc type is an adapter to allow the use of ordinary
// function as RunLog mutator.
type RunLogFunc func(context.Context, *ent.RunLogMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RunLogFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RunLogMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RunLogMutation", m)
}
