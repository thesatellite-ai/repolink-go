...
func (_c *ProfileCreate) SetHostname(v string) *ProfileCreate {
...
func (_c *ProfileCreate) SetNillableID(v *string) *ProfileCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *ProfileCreate) check() error {
	...
	if _, ok := _c.mutation.Hostname(); !ok {
		return &ValidationError{Name: "hostname", err: errors.New(`ent: missing required field "Profile.hostname"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
